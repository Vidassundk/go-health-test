...
export const OPTION_INACTIVE_OPACITY = 0.5;
export const ERROR_ANIMATION_DURATION_MS = 200;
export const ERROR_MESSAGE_HEIGHT = 22;
export const ERROR_EXIT_PHASE1_MS = 120;
export const ERROR_EXIT_PHASE2_MS = 80;
export const ERROR_EXIT_TRANSLATE_Y = -12;
